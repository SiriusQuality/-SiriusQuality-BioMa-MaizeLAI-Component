...
namespace SiriusQualityMaizeLAI.Strategies
{
	...
	#region Constructor
			...
			public DeltaLAIMaize()
			{
				...
				pd5.PropertyName = "length";
				pd5.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.length)).ValueType.TypeForCurrentValue;
				pd5.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.length);
				_inputs0_0.Add(pd5);
				PropertyDescription pd6 = new PropertyDescription();
				pd6.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd6.PropertyName = "State";
				pd6.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.State)).ValueType.TypeForCurrentValue;
				pd6.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.State);
				_inputs0_0.Add(pd6);
				PropertyDescription pd7 = new PropertyDescription();
				pd7.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd7.PropertyName = "fullyExpTT";
				pd7.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.fullyExpTT)).ValueType.TypeForCurrentValue;
				pd7.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.fullyExpTT);
				_inputs0_0.Add(pd7);
				PropertyDescription pd8 = new PropertyDescription();
				pd8.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd8.PropertyName = "GAI";
				pd8.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.GAI)).ValueType.TypeForCurrentValue;
				pd8.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.GAI);
				_inputs0_0.Add(pd8);
				PropertyDescription pd9 = new PropertyDescription();
				pd9.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd9.PropertyName = "startExpTT";
				pd9.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startExpTT)).ValueType.TypeForCurrentValue;
				pd9.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startExpTT);
				_inputs0_0.Add(pd9);
				PropertyDescription pd10 = new PropertyDescription();
				pd10.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd10.PropertyName = "coefLER";
				pd10.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.coefLER)).ValueType.TypeForCurrentValue;
				pd10.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.coefLER);
				_inputs0_0.Add(pd10);
				PropertyDescription pd11 = new PropertyDescription();
				pd11.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd11.PropertyName = "fracPopn";
				pd11.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.fracPopn)).ValueType.TypeForCurrentValue;
				pd11.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.fracPopn);
				_inputs0_0.Add(pd11);
				PropertyDescription pd12 = new PropertyDescription();
				pd12.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd12.PropertyName = "tipTT";
				pd12.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.tipTT)).ValueType.TypeForCurrentValue;
				pd12.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.tipTT);
				_inputs0_0.Add(pd12);
				PropertyDescription pd13 = new PropertyDescription();
				pd13.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd13.PropertyName = "liguleTT";
				pd13.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.liguleTT)).ValueType.TypeForCurrentValue;
				pd13.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.liguleTT);
				_inputs0_0.Add(pd13);
				PropertyDescription pd14 = new PropertyDescription();
				pd14.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd14.PropertyName = "stopEnlargeTT";
				pd14.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.stopEnlargeTT)).ValueType.TypeForCurrentValue;
				pd14.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.stopEnlargeTT);
				_inputs0_0.Add(pd14);
				PropertyDescription pd15 = new PropertyDescription();
				pd15.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd15.PropertyName = "startEnlargeTT";
				pd15.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startEnlargeTT)).ValueType.TypeForCurrentValue;
				pd15.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startEnlargeTT);
				_inputs0_0.Add(pd15);
				PropertyDescription pd16 = new PropertyDescription();
				pd16.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd16.PropertyName = "leafAge";
				pd16.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.leafAge)).ValueType.TypeForCurrentValue;
				pd16.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.leafAge);
				_inputs0_0.Add(pd16);
				PropertyDescription pd17 = new PropertyDescription();
				pd17.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd17.PropertyName = "cumIntRad";
				pd17.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.cumIntRad)).ValueType.TypeForCurrentValue;
				pd17.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.cumIntRad);
				_inputs0_0.Add(pd17);
				PropertyDescription pd18 = new PropertyDescription();
				pd18.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLAIState);
				pd18.PropertyName = "radIntercepted";
				pd18.PropertyType = (( SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.radIntercepted)).ValueType.TypeForCurrentValue;
				pd18.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.radIntercepted);
				_inputs0_0.Add(pd18);
				PropertyDescription pd19 = new PropertyDescription();
				pd19.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd19.PropertyName = "exposedArea";
				pd19.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.exposedArea)).ValueType.TypeForCurrentValue;
				pd19.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.exposedArea);
				_inputs0_0.Add(pd19);
				PropertyDescription pd20 = new PropertyDescription();
				pd20.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd20.PropertyName = "baseWidth";
				...
				pd28.PropertyName = "width";
				pd28.PropertyType =  (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.width)).ValueType.TypeForCurrentValue;
				pd28.PropertyVarInfo =(  SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.width);
				...
				pd29.PropertyName = "isPrematurelyDying";
				pd29.PropertyType =  (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.isPrematurelyDying)).ValueType.TypeForCurrentValue;
				pd29.PropertyVarInfo =(  SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.isPrematurelyDying);
				...
				pd30.PropertyName = "cumIntRad";
				pd30.PropertyType =  (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.cumIntRad)).ValueType.TypeForCurrentValue;
				pd30.PropertyVarInfo =(  SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.cumIntRad);
				...
				pd31.PropertyName = "leafAge";
				pd31.PropertyType =  (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.leafAge)).ValueType.TypeForCurrentValue;
				pd31.PropertyVarInfo =(  SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.leafAge);
				_outputs0_0.Add(pd31);
				PropertyDescription pd32 = new PropertyDescription();
				pd32.DomainClassType = typeof(SiriusQualityMaizeLAI.MaizeLeafState);
				pd32.PropertyName = "exposedArea";
	...
	#region pre/post conditions management		
			...
			public string TestPostConditions(SiriusQualityMaizeLAI.MaizeLAIState maizelaistate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate1, string callID)
			{
				try
				{
					...
					if(r29.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.isPrematurelyDying.ValueType)){prc.AddCondition(r29);}
					RangeBasedCondition r30 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.cumIntRad);
					if(r30.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.cumIntRad.ValueType)){prc.AddCondition(r30);}
					RangeBasedCondition r31 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.leafAge);
			...
			public string TestPreConditions(SiriusQualityMaizeLAI.MaizeLAIState maizelaistate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate1, string callID)
			{
				try
				{
					...
					RangeBasedCondition r5 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.length);
					if(r5.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.length.ValueType)){prc.AddCondition(r5);}
					RangeBasedCondition r6 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.State);
					if(r6.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.State.ValueType)){prc.AddCondition(r6);}
					RangeBasedCondition r7 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.fullyExpTT);
					if(r7.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.fullyExpTT.ValueType)){prc.AddCondition(r7);}
					RangeBasedCondition r8 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.GAI);
					if(r8.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.GAI.ValueType)){prc.AddCondition(r8);}
					RangeBasedCondition r9 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startExpTT);
					if(r9.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startExpTT.ValueType)){prc.AddCondition(r9);}
					RangeBasedCondition r10 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.coefLER);
					if(r10.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.coefLER.ValueType)){prc.AddCondition(r10);}
					RangeBasedCondition r11 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.fracPopn);
					if(r11.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.fracPopn.ValueType)){prc.AddCondition(r11);}
					RangeBasedCondition r12 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.tipTT);
					if(r12.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.tipTT.ValueType)){prc.AddCondition(r12);}
					RangeBasedCondition r13 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.liguleTT);
					if(r13.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.liguleTT.ValueType)){prc.AddCondition(r13);}
					RangeBasedCondition r14 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.stopEnlargeTT);
					if(r14.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.stopEnlargeTT.ValueType)){prc.AddCondition(r14);}
					RangeBasedCondition r15 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startEnlargeTT);
					if(r15.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startEnlargeTT.ValueType)){prc.AddCondition(r15);}
					RangeBasedCondition r16 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.leafAge);
					if(r16.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.leafAge.ValueType)){prc.AddCondition(r16);}
					RangeBasedCondition r17 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.cumIntRad);
					if(r17.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.cumIntRad.ValueType)){prc.AddCondition(r17);}
					RangeBasedCondition r18 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.radIntercepted);
					if(r18.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.radIntercepted.ValueType)){prc.AddCondition(r18);}
					RangeBasedCondition r19 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.exposedArea);
