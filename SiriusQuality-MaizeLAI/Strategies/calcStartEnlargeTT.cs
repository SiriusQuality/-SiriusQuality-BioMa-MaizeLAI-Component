...
namespace SiriusQualityMaizeLAI.Strategies
{
	...
	/// <summary>
	///Class calcStartEnlargeTT
    /// Calculate Thermal Time at begining of width increase.
    /// </summary>
	public class calcStartEnlargeTT : IStrategySiriusQualityMaizeLAI
	{

	#region Constructor

			public calcStartEnlargeTT()
			{
				...
				pd1.PropertyName = "startExpTT";
				pd1.PropertyType = (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startExpTT)).ValueType.TypeForCurrentValue;
				pd1.PropertyVarInfo =( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startExpTT);
				_inputs0_0.Add(pd1);
				...
				pd5.PropertyName = "startEnlargeTT";
				pd5.PropertyType =  (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startEnlargeTT)).ValueType.TypeForCurrentValue;
				pd5.PropertyVarInfo =(  SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startEnlargeTT);
				_outputs0_0.Add(pd5);
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate Thermal Time at begining of width increase."; }
			}
	...
	#region pre/post conditions management		
			...
			public string TestPostConditions(SiriusQualityMaizeLAI.MaizeLAIState maizelaistate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate1, string callID)
			{
				try
				{
					...
					RangeBasedCondition r5 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startEnlargeTT);
					if(r5.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startEnlargeTT.ValueType)){prc.AddCondition(r5);}
			...
			public string TestPreConditions(SiriusQualityMaizeLAI.MaizeLAIState maizelaistate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate1, string callID)
			{
				try
				{
					...
					RangeBasedCondition r1 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startExpTT);
					if(r1.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.startExpTT.ValueType)){prc.AddCondition(r1);}
