...
namespace SiriusQualityMaizeLAI.Strategies
{
	...
	/// <summary>
	///Class calcLERCoeff
    /// Calculate the coefficient for conversion of lef elongation rate in mm/day to expension rate in mm/oCd
    /// </summary>
	public class calcLERCoeff : IStrategySiriusQualityMaizeLAI
	{
	...
	#region Constructor
			...
			public calcLERCoeff()
			{
				...
				VarInfo v2 = new VarInfo();
				 v2.DefaultValue = 0.59;
				 v2.Description = "Distance between inflexion points relative to maximum number of leaves";
				 v2.Id = 0;
				 v2.MaxValue = 1;
				 v2.MinValue = 0;
				 v2.Name = "Beta";
				 v2.Size = 1;
				 v2.Units = "dimensioless";
				 v2.URL = "";
				 v2.VarType = CRA.ModelLayer.Core.VarInfo.Type.STATE;
				 v2.ValueType = VarInfoValueTypes.GetInstanceForName("Double");
				 _parameters0_0.Add(v2);
				VarInfo v3 = new VarInfo();
				 v3.DefaultValue = 0.35;
				 v3.Description = "Leaf rank of the maximum potential elongation rate relative to maximum leaf number";
				 v3.Id = 0;
				 v3.MaxValue = 1;
				 v3.MinValue = 0;
				 v3.Name = "Sigma";
				 v3.Size = 1;
				 v3.Units = "dimensioless";
				 v3.URL = "";
				...
				pd4.PropertyName = "coefLER";
				pd4.PropertyType =  (( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.coefLER)).ValueType.TypeForCurrentValue;
				pd4.PropertyVarInfo =(  SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.coefLER);
				_outputs0_0.Add(pd4);
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate the coefficient for conversion of lef elongation rate in mm/day to expension rate in mm/oCd"; }
			}
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						...
						else throw new Exception("Parameter 'Nfinal' not found (or found null) in strategy 'calcLERCoeff'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("Nfinal");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'Nfinal' not found in strategy 'calcLERCoeff'");
				}
			}
			public Double Beta
			{ 
				get {
						VarInfo vi= _modellingOptionsManager.GetParameterByName("Beta");
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'Beta' not found (or found null) in strategy 'calcLERCoeff'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("Beta");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'Beta' not found in strategy 'calcLERCoeff'");
				}
			}
			public Double Sigma
			{ 
				get {
						VarInfo vi= _modellingOptionsManager.GetParameterByName("Sigma");
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'Sigma' not found (or found null) in strategy 'calcLERCoeff'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("Sigma");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'Sigma' not found in strategy 'calcLERCoeff'");
				}
			}
	...
	#region Static parameters VarInfo definition
			...
			{                                
				...
				NfinalVarInfo.Units = "°Cd/leaf";
				NfinalVarInfo.ValueType = CRA.ModelLayer.Core.VarInfoValueTypes.GetInstanceForName("Double");

				BetaVarInfo.Name = "Beta";
				BetaVarInfo.Description =" Distance between inflexion points relative to maximum number of leaves";
				BetaVarInfo.MaxValue = 1;
				BetaVarInfo.MinValue = 0;
				BetaVarInfo.DefaultValue = 0.59;
				BetaVarInfo.Units = "dimensioless";
				BetaVarInfo.ValueType = CRA.ModelLayer.Core.VarInfoValueTypes.GetInstanceForName("Double");

				SigmaVarInfo.Name = "Sigma";
				SigmaVarInfo.Description =" Leaf rank of the maximum potential elongation rate relative to maximum leaf number";
				SigmaVarInfo.MaxValue = 1;
				SigmaVarInfo.MinValue = 0;
				SigmaVarInfo.DefaultValue = 0.35;
				SigmaVarInfo.Units = "dimensioless";
				SigmaVarInfo.ValueType = CRA.ModelLayer.Core.VarInfoValueTypes.GetInstanceForName("Double");
			...
			//Parameters static VarInfo list 
				...
				private static VarInfo _BetaVarInfo= new VarInfo();
				/// <summary> 
				///Beta VarInfo definition
				/// </summary>
				public static VarInfo BetaVarInfo
				{
					get { return _BetaVarInfo; }
				}
				private static VarInfo _SigmaVarInfo= new VarInfo();
				/// <summary> 
				///Sigma VarInfo definition
				/// </summary>
				public static VarInfo SigmaVarInfo
				{
					get { return _SigmaVarInfo; }
				}					
	...
	#region pre/post conditions management		
			...
			public string TestPostConditions(SiriusQualityMaizeLAI.MaizeLAIState maizelaistate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate1, string callID)
			{
				try
				{
					...
					RangeBasedCondition r4 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.coefLER);
					if(r4.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.coefLER.ValueType)){prc.AddCondition(r4);}
			...
			public string TestPreConditions(SiriusQualityMaizeLAI.MaizeLAIState maizelaistate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate1, string callID)
			{
				try
				{
					...
					prc.AddCondition(new RangeBasedCondition(_modellingOptionsManager.GetParameterByName("Beta")));
					prc.AddCondition(new RangeBasedCondition(_modellingOptionsManager.GetParameterByName("Sigma")));
