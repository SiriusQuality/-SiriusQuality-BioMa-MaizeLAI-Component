...
namespace SiriusQualityMaizeLAI.Strategies
{
	...
	/// <summary>
	///Class calcLER
    /// Calcul expansion rate of leaf six
    /// </summary>
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calcul expansion rate of leaf six"; }
			}
	...
	#region pre/post conditions management		
			...
			public string TestPreConditions(SiriusQualityMaizeLAI.MaizeLAIState maizelaistate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate1, string callID)
			{
				try
				{
					...
					SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.TCanopyHourly.CurrentValue=maizelaistate.TCanopyHourly;
					...
					RangeBasedCondition r2 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.VPDeq);
					if(r2.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.VPDeq.ValueType)){prc.AddCondition(r2);}
					RangeBasedCondition r3 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.TCanopyHourly);
					if(r3.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.TCanopyHourly.ValueType)){prc.AddCondition(r3);}
