...
namespace SiriusQualityMaizeLAI.Strategies
{
	...
	/// <summary>
	///Class calcTipTT
    /// Calculate Thermal Time at Tip emergence
    /// </summary>
	public class calcTipTT : IStrategySiriusQualityMaizeLAI
	{
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate Thermal Time at Tip emergence"; }
			}
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						...
						else throw new Exception("Parameter 'Dse' not found (or found null) in strategy 'calcTipTT'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("Dse");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'Dse' not found in strategy 'calcTipTT'");
				}
			}
			public Double atip
			{ 
				get {
						...
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'atip' not found (or found null) in strategy 'calcTipTT'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("atip");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'atip' not found in strategy 'calcTipTT'");
				}
			}
			public Double btip
			{ 
				get {
						...
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'btip' not found (or found null) in strategy 'calcTipTT'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("btip");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'btip' not found in strategy 'calcTipTT'");
				}
			}
	...
	#region pre/post conditions management		
			...
			public string TestPostConditions(SiriusQualityMaizeLAI.MaizeLAIState maizelaistate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate1, string callID)
			{
				try
				{
					...
					RangeBasedCondition r6 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.tipTT);
					if(r6.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.tipTT.ValueType)){prc.AddCondition(r6);}
			...
			public string TestPreConditions(SiriusQualityMaizeLAI.MaizeLAIState maizelaistate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate1, string callID)
			{
				try
				{
					...
					RangeBasedCondition r4 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.cumulTTPHenoMaize);
					if(r4.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.cumulTTPHenoMaize.ValueType)){prc.AddCondition(r4);}
					RangeBasedCondition r5 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.deltaTTPhenoMaize);
					if(r5.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.deltaTTPhenoMaize.ValueType)){prc.AddCondition(r5);}
