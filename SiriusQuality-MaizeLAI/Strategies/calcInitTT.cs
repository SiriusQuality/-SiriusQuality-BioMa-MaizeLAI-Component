...
namespace SiriusQualityMaizeLAI.Strategies
{
	...
	/// <summary>
	///Class calcInitTT
    /// Calcul thermal time at initialization of leaf
    /// </summary>
	public class calcInitTT : IStrategySiriusQualityMaizeLAI
	{
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calcul thermal time at initialization of leaf"; }
			}
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						VarInfo vi= _modellingOptionsManager.GetParameterByName("leafNoInitEmerg");
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'leafNoInitEmerg' not found (or found null) in strategy 'calcInitTT'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("leafNoInitEmerg");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'leafNoInitEmerg' not found in strategy 'calcInitTT'");
				}
			}
			public Double LIR
			{ 
				get {
						VarInfo vi= _modellingOptionsManager.GetParameterByName("LIR");
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'LIR' not found (or found null) in strategy 'calcInitTT'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("LIR");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'LIR' not found in strategy 'calcInitTT'");
				}
			}
			public Double ttinitflo
			{ 
				get {
						VarInfo vi= _modellingOptionsManager.GetParameterByName("ttinitflo");
						if (vi != null && vi.CurrentValue!=null) return (Double)vi.CurrentValue ;
						else throw new Exception("Parameter 'ttinitflo' not found (or found null) in strategy 'calcInitTT'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("ttinitflo");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'ttinitflo' not found in strategy 'calcInitTT'");
				}
			}
	...
	#region Static parameters VarInfo definition
			...
			{                                
                leafNoInitEmergVarInfo.Name = "leafNoInitEmerg";
				leafNoInitEmergVarInfo.Description =" number of leaves initiated at plant emergence";
				leafNoInitEmergVarInfo.MaxValue = 50;
				leafNoInitEmergVarInfo.MinValue = 0;
				leafNoInitEmergVarInfo.DefaultValue = 2;
				leafNoInitEmergVarInfo.Units = "leaves";
				leafNoInitEmergVarInfo.ValueType = CRA.ModelLayer.Core.VarInfoValueTypes.GetInstanceForName("Double");

				LIRVarInfo.Name = "LIR";
				LIRVarInfo.Description =" leaf initiation rate";
				LIRVarInfo.MaxValue = 10;
				LIRVarInfo.MinValue = 0;
				LIRVarInfo.DefaultValue = 0.1;
				LIRVarInfo.Units = "leaf/°Cd";
				LIRVarInfo.ValueType = CRA.ModelLayer.Core.VarInfoValueTypes.GetInstanceForName("Double");

				ttinitfloVarInfo.Name = "ttinitflo";
				ttinitfloVarInfo.Description =" Thermal time of floral initiations of leaves created before emergence";
				ttinitfloVarInfo.MaxValue = 150;
				ttinitfloVarInfo.MinValue = 0;
				ttinitfloVarInfo.DefaultValue = 28;
				ttinitfloVarInfo.Units = "°Cd";
				ttinitfloVarInfo.ValueType = CRA.ModelLayer.Core.VarInfoValueTypes.GetInstanceForName("Double");
			...
			//Parameters static VarInfo list 
				...
				private static VarInfo _leafNoInitEmergVarInfo= new VarInfo();
				/// <summary> 
				///leafNoInitEmerg VarInfo definition
				/// </summary>
				public static VarInfo leafNoInitEmergVarInfo
				{
					get { return _leafNoInitEmergVarInfo; }
				}
				private static VarInfo _LIRVarInfo= new VarInfo();
				/// <summary> 
				///LIR VarInfo definition
				/// </summary>
				public static VarInfo LIRVarInfo
				{
					get { return _LIRVarInfo; }
				}
				private static VarInfo _ttinitfloVarInfo= new VarInfo();
				/// <summary> 
				///ttinitflo VarInfo definition
				/// </summary>
				public static VarInfo ttinitfloVarInfo
				{
					get { return _ttinitfloVarInfo; }
				}					
	...
	#region pre/post conditions management		
			...
			public string TestPostConditions(SiriusQualityMaizeLAI.MaizeLAIState maizelaistate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate1, string callID)
			{
				try
				{
					...
					SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.initialisationTT.CurrentValue=maizeleafstate.initialisationTT;
					...
					RangeBasedCondition r4 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.initialisationTT);
					if(r4.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLeafStateVarInfo.initialisationTT.ValueType)){prc.AddCondition(r4);}
			...
			public string TestPreConditions(SiriusQualityMaizeLAI.MaizeLAIState maizelaistate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate,SiriusQualityMaizeLAI.MaizeLeafState maizeleafstate1, string callID)
			{
				try
				{
					...
					RangeBasedCondition r1 = new RangeBasedCondition(SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.previousLeafNumber);
					if(r1.ApplicableVarInfoValueTypes.Contains( SiriusQualityMaizeLAI.MaizeLAIStateVarInfo.previousLeafNumber.ValueType)){prc.AddCondition(r1);}
					...
					prc.AddCondition(new RangeBasedCondition(_modellingOptionsManager.GetParameterByName("leafNoInitEmerg")));
					prc.AddCondition(new RangeBasedCondition(_modellingOptionsManager.GetParameterByName("LIR")));
					prc.AddCondition(new RangeBasedCondition(_modellingOptionsManager.GetParameterByName("ttinitflo")));
	...
	#region Model
			...
			{				
                ...
                if (maizelaistate.newLeafHasAppeared == 1)
                {
                    ...
                    {
                        maizeleafstate.initialisationTT[index] = calculateInitTT(index, ttinitflo); 
                    }
                }
